...
constexpr int kOutputSampleElems = kOutputTilePixels;
...
constexpr int kTileCount = kTileRowCount * kTileColCount;

constexpr int kImageInputStreamRows = kTileCount * kInputLogicalRows;
...
constexpr int kGraphRunIterations = kTileCount;
...
constexpr int kAieOutputTiles = kGraphRunIterations;
...
constexpr int kMidElems = kGraphRunIterations * kMidElemsPerTile;
...
constexpr int kGradElems = kGraphRunIterations * kGradElemsPerTile;
...
constexpr int kImageInputStreamBytes =
    kGraphRunIterations * kInputTileBytes;
