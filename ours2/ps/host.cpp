// Spill SRAD mapping:
//   4 PL TopPL CUs stream sixteen 16x16 tiles to 16 AIE lanes.
//   Each TopPL controls four AIE lanes.
...
int main(int argc, char* argv[]) {
    ...
    std::printf("mapping               : 4x TopPL + Q0Ctrl + 16-lane AIE K1/K2 (%d lane(s)/TopPL)\n",
    ...
    try {
        ...
        std::printf("---- 4x TopPL + Q0Ctrl + GraphOursPLQ0, 16 AIE lanes ----\n");
        std::printf("PL input              : DDR J float[%d]\n",
                    srad_cfg::kPixels);
        std::printf("PL q0/output packing  : each TopPL merges %d lane stats; Q0Ctrl reduces 4 worker partial stats; q0sqr embedded in first padding column of each 19x24 J tile\n",
                    srad_cfg::kWorkerLanes);
