...
//   lambda PLIO ------------^
//
// Each graph firing consumes one packed 16x16 tile from a 32x32 image. The
// fused kernel computes coefficients and gradients for all 16 rows first, then
// updates the full 256-point tile. The per-tile intermediates stay local to the
// AIE core instead of materializing the whole mid plane through PLIO/DDR.
//
