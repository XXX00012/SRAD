...
public:
    ...
    GraphPrepare(const std::string& graphID) {
        ...
        source(k_prepare) = "ProcessUnit/srad_prepare.cc";
        headers(k_prepare) = {"ProcessUnit/srad.h", "ProcessUnit/include.h", "Config.h"};
...
public:
    ...
    GraphReduce(const std::string& graphID) {
        ...
        source(k_reduce) = "ProcessUnit/srad_reduce_q0.cc";
        headers(k_reduce) = {"ProcessUnit/srad.h", "ProcessUnit/include.h", "Config.h"};
...
public:
    ...
    GraphCoeff(const std::string& graphID) {
        ...
        source(k_coeff) = "ProcessUnit/srad_coeff.cc";
        headers(k_coeff) = {"ProcessUnit/srad.h", "ProcessUnit/include.h", "Config.h"};
...
public:
    ...
    GraphUpdate(const std::string& graphID) {
        ...
        source(k_update) = "ProcessUnit/srad_update.cc";
        headers(k_update) = {"ProcessUnit/srad.h", "ProcessUnit/include.h", "Config.h"};
