...
#pragma HLS DATAFLOW
    ...
    next_sum = group0_sum + group1_sum + group2_sum + group3_sum + group4_sum;
    next_sum2 = group0_sum2 + group1_sum2 + group2_sum2 + group3_sum2 + group4_sum2;
}
