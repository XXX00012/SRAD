...
constexpr int kAieArrayCols = 5;
constexpr int kAieArrayRows = 8;
constexpr int kParallelLanes = 20;
...
constexpr int kSradIterations = 3;
...
constexpr int kMidElems = kAieOutputTiles * kMidElemsPerTile;
...
constexpr int kGradElems = kAieOutputTiles * kGradElemsPerTile;
...
constexpr int kImageInputStreamBytes =
    kAieOutputTiles * kInputTileBytes;
...
constexpr int kGradBytes = kGradElems * kScalarBytes;
...
static_assert(kTopPlWorkers == 1,
              "ours_16 generated config expects 1 PL workers");
static_assert(kParallelLanes == 20,
              "ours_16 generated config expects 20 AIE lanes");
static_assert(kWorkerLanes == 20,
              "ours_16 generated config expects 20 AIE lanes per PL worker");
static_assert(kWorkerGroupLanes == 4,
              "ours_16 generated config expects 4 AIE lanes per worker group");
...
static_assert(kParallelLanes % kOutputLanesPerPlio == 0,
              "Output PLIO groups must evenly pack AIE lanes");
static_assert(kWorkerOutputGroups * kOutputLanesPerPlio == kWorkerLanes,
              "Each worker must own enough merged output PLIO groups for its lanes");
