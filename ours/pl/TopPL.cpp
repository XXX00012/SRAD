...
//   PLIO result + tile stats -> DDR. Multi-iteration runs ping-pong between
//   image/output buffers; q0sqr after the first iteration comes from AIE stats.
...
#pragma HLS DATAFLOW
    ...
    read_all_tiles(output, in_j_next, next_sum, next_sum2);
}
