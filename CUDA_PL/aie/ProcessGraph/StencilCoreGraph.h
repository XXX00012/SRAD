...
// CUDA_PL mirrors SRAD/CUDA after the first stage. PL TopPL computes
// OpenCL-v0 q0sqr; GraphCoeff and GraphUpdate remain the same AIE kernels and
// data layout used by SRAD/CUDA.
